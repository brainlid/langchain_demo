...
config :langchain_demo, LangchainDemoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "cmIvAml9TIE3DG5kUpLX/9kV7mEc4komzamfkCILKA2v6qIrsx1jBA0fHzNb01fg",
  watchers: [
...
config :langchain_demo, LangchainDemoWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/langchain_demo_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :langchain_demo, dev_routes: true
